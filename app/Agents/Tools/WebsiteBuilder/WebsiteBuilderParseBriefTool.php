...
/**
 * Parse product briefs from various sources for website projects.
 *
 * Extracts structured requirements from PDFs, Google Docs, or text content
 * and stores results in the WebsiteProject model.
 */
class WebsiteBuilderParseBriefTool extends BaseTool
{
    ...
    {
        return 'Parse a product brief from PDF, Google Doc, or text to extract brand guidelines, site requirements, and content specifications. Stores results in the project design_config.';
    }
    ...
    public function execute(array $params): array
    {
        ...
        // Store in project design_config
        $designConfig = $project->design_config ?? [];
        $designConfig['parsed_brief'] = $parsed;
        $designConfig['brief_source_type'] = $params['source_type'];
        $designConfig['brief_parsed_at'] = now()->toIso8601String();
